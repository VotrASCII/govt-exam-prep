...
.nav-links{display:flex;flex-wrap:wrap;gap:.9rem 1.4rem;justify-content:flex-end}
.nav-links a{
...
/* ---- exam categorisation ---- */
.exam-grid-wrap{padding-top:1rem}
.exam-grid{
...
.exam-card{
  ...
  padding:1.8rem 1.6rem 1.5rem;border:1px solid var(--line);border-radius:.5rem;
...
.exam-card h3{font-family:'Instrument Serif',serif;font-size:1.6rem;font-weight:400}
.exam-card .ec-blurb{color:var(--ink-soft);font-size:.9rem;line-height:1.5;flex:1}
.exam-card .ec-foot{
  display:flex;flex-direction:column;gap:.2rem;
  font-family:'JetBrains Mono',monospace;font-size:.72rem;letter-spacing:.02em;
  color:var(--ink-soft);padding-top:.6rem;border-top:1px solid var(--line-soft);
}
.exam-card .ec-meta{color:var(--accent)}
.exam-card .ec-go{font-family:'JetBrains Mono',monospace;font-size:.78rem;color:var(--ink)}
.exam-card:hover .ec-go{color:var(--accent)}

.exam-hero{padding-bottom:clamp(2rem,5vh,4rem)}
.exam-empty{
...
.archive-cycle summary{
  cursor:pointer;list-style:none;padding:1.1rem .4rem;
...
.archive-cycle summary::-webkit-details-marker{display:none}
.archive-cycle summary::before{content:"+";color:var(--accent);font-size:1rem}
.archive-cycle[open] summary::before{content:"–"}
.archive-cycle summary .ac-count{color:var(--ink-soft);font-size:.72rem}
.archive-cycle .week-list{border-top:1px solid var(--line-soft)}
...
/* ---- news page ---- */
.hero-tight{padding:clamp(3rem,9vh,6rem) 0 clamp(2rem,5vh,3.5rem)}
...
.filter{
  font-family:'JetBrains Mono',monospace;font-size:.72rem;letter-spacing:.02em;
  background:none;border:1px solid var(--line);color:var(--ink-soft);
  padding:.4rem .85rem;border-radius:2px;cursor:pointer;transition:.2s;
}
.filter:hover{border-color:var(--accent-soft);color:var(--ink)}
...
.news-card{
  ...
  background:var(--bg);padding:1.5rem 1.4rem 1.3rem;
...
.nc-meta{
  ...
  font-family:'JetBrains Mono',monospace;font-size:.66rem;letter-spacing:.03em;
  text-transform:uppercase;color:var(--muted);
}
.nc-date{color:var(--accent)}
.nc-source{font-weight:500;color:var(--ink-soft)}
.nc-topic{margin-left:auto;color:var(--muted)}
.nc-title{
  font-family:'Instrument Serif',serif;font-weight:400;font-size:1.35rem;
  line-height:1.15;letter-spacing:-.01em;color:var(--ink);
}
.nc-summary{color:var(--ink-soft);font-size:.95rem;line-height:1.58;flex:1}
.nc-foot{
  display:flex;align-items:center;justify-content:space-between;gap:.8rem;
  margin-top:.4rem;padding-top:.8rem;border-top:1px solid var(--line-soft);
}
.nc-chips{display:flex;flex-wrap:wrap;gap:.35rem}
.chip{
  font-family:'JetBrains Mono',monospace;font-size:.6rem;letter-spacing:.03em;
  border:1px solid var(--line);border-radius:2px;padding:.2rem .4rem;color:var(--ink-soft);
}
.nc-cite{
